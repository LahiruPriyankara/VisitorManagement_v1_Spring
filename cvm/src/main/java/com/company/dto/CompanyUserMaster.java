...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CompanyUserMaster.findAll", query = "SELECT d FROM CompanyUserMaster d"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserMasterId", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserMasterId = :companyUserMasterId"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserEmpId", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserEmpId = :companyUserEmpId"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserFirstName", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserFirstName = :companyUserFirstName"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserMiddleName", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserMiddleName = :companyUserMiddleName"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserLastName", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserLastName = :companyUserLastName"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserGender", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserGender = :companyUserGender"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserGrade", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserGrade = :companyUserGrade"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserDestination", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserDestination = :companyUserDestination"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserDivId", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserDivId = :companyUserDivId"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserDepName", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserDepName = :companyUserDepName"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserFloor", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserFloor = :companyUserFloor"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserJobDesc", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserJobDesc = :companyUserJobDesc"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserDepExten", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserDepExten = :companyUserDepExten"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserOfficeMobile", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserOfficeMobile = :companyUserOfficeMobile"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserOfficeExten", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserOfficeExten = :companyUserOfficeExten"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserOfficeEmail", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserOfficeEmail = :companyUserOfficeEmail"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserContactPersonName", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserContactPersonName = :companyUserContactPersonName"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserContactPersonMobile", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserContactPersonMobile = :companyUserContactPersonMobile"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserContactPersonExten", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserContactPersonExten = :companyUserContactPersonExten"),
		@NamedQuery(name = "CompanyUserMaster.findBycompanyUserRemarks", query = "SELECT d FROM CompanyUserMaster d WHERE d.companyUserRemarks = :companyUserRemarks"),
		@NamedQuery(name = "CompanyUserMaster.findByCreatedBy", query = "SELECT d FROM CompanyUserMaster d WHERE d.createdBy = :createdBy"),
		@NamedQuery(name = "CompanyUserMaster.findByCreatedDate", query = "SELECT d FROM CompanyUserMaster d WHERE d.createdDate = :createdDate"),
		@NamedQuery(name = "CompanyUserMaster.findByModifiedBy", query = "SELECT d FROM CompanyUserMaster d WHERE d.modifiedBy = :modifiedBy"),
		@NamedQuery(name = "CompanyUserMaster.findByModifiedDate", query = "SELECT d FROM CompanyUserMaster d WHERE d.modifiedDate = :modifiedDate"),
		@NamedQuery(name = "CompanyUserMaster.findByVerifiedBy", query = "SELECT d FROM CompanyUserMaster d WHERE d.verifiedBy = :verifiedBy"),
		@NamedQuery(name = "CompanyUserMaster.findByVerifiedDate", query = "SELECT d FROM CompanyUserMaster d WHERE d.verifiedDate = :verifiedDate"),
		@NamedQuery(name = "CompanyUserMaster.findByUserStatus", query = "SELECT d FROM CompanyUserMaster d WHERE d.userStatus = :userStatus") })
